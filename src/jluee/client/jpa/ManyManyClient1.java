...
public class ManyManyClient1 {


 public static void main(String[] args) throws Exception 
  {   	  
     EntityManagerFactory factory =
       Persistence.createEntityManagerFactory("many2many1",null);
   ...
   {
	   Student_m2m1 s=new Student_m2m1();
	   s.setName("Student1");
	   s.setGender("male");
	   s.setMajor("computer technology");
	   Teacher_m2m1 t1=new Teacher_m2m1();
	   t1.setTeacherName("TeacherB");
	   t1.setAge(31);
	   t1.setGender("male");
	   s.getTeachers().add(t1);
	   Teacher_m2m1 t2=new Teacher_m2m1();
	   t2.setTeacherName("TeacherA");
	   t2.setAge(36);
	   t2.setGender("female");
  ...
  public static void showAll(EntityManager manager)
   {
        ...
        transaction.commit();
         ...
         while(it.hasNext())
        {
        	 Student_m2m1 p=(Student_m2m1)it.next();
